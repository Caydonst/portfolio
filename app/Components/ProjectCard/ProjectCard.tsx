...
export default function ProjectCard({ flipped = false, image, title, description, technology, website }: ProjectCardProps) {

    return (
        <div className={`${styles.ProjectCard} ${flipped ? styles.flipped : ""}`}>
